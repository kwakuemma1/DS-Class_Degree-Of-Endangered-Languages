...
-   Model A: Predict the degree of language endangerment
-   Model B: Predict the probability of language endangerment. With Model B, the plan is to predict the probability of an endangered language evolving from one classification to the order.
...
-   Other social and economic factors do seem to impact degree of endangerment when urbanization is considered
