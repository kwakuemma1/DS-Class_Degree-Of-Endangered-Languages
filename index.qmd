...
The purpose of project is to explore some of the global factors affecting language endangerment in an attempt to find ways to help save endangered languages. Some factors affecting global language endangerment are explored. A Bayesian linear model was subsequently built to verify the significance of these factors, and predict the degree of language endangerment.
